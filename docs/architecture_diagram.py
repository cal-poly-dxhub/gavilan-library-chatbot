...
"NOT wired here yet: ... Bedrock Guardrails, the widget, WAF, and auth"): Guardrails, WAF.
The chat widget (frontend/ is empty) is drawn as an external client marked planned.
"""
